...
public class CalendarPickerView extends ListView {
    ...
    public class FluentInitializer {
        ...
        /**
         * Mark
         * This function to highlight list of range dates
         *
         *
         */
        public FluentInitializer withHighlightedRangeDates(List<Map<Date, Date>> listRangeOfDates) {
         ...
         * @param end
         */
        public void highlightRangeDates(Date start, Date end) {
